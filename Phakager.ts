...
if (Object.keys(values).length === 0 || values.help) {
    console.log(dedent(`
        ...
        options:
            ...
            -v, --update_versioning Adds current build to versions.json file; is ignored if -k is omitted.
            ...
            -d, --dev               Marks current manifest.json file as a developer build; prevents -v usage.
